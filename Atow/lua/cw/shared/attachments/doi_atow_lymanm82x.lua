local att = {}
att.name = "doi_atow_lymanm82x"
att.displayNameShort = "M82 1.5x"
att.displayName = "M82 Lyman"
att.aimPos = {"LymanxPos", "LymanxAng"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	...
	att.description = {
		[1] = {t = "American 1.5x magnification scope.", c = CustomizableWeaponry.textColors.POSITIVE},
		[2] = {t = "For short-medium range.", c = CustomizableWeaponry.textColors.POSITIVE}
	}
