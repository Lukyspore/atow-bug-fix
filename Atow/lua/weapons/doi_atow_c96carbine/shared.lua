...
if CLIENT then
	...
	SWEP.ZF41Pos = Vector(-2.34, -1.5, 0.03)
	...
	SWEP.BackupSights = {["doi_atow_zf41"] = {[1] = Vector(-2.3262, -2, 1.1502), [2] = Vector(0.2202, 0.0439, 0)},}
	...
	["doi_atow_zf41"] = {model = "models/khrcw2/doipack/attachments/kar98k1xscope.mdl", pos = Vector(-0.45, -0.1, 1.55), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), bone = "Weapon"},
	}
...
[3] = {header = "Optic", offset = {350, -375}, atts = {"doi_atow_zf41"}},
[5] = {header = "Fire Control", offset = {1050, -250}, atts = {"doi_atow_heavybolt"}},
["+reload"] = {header = "Ammo", offset = {-300, 150}, atts = {"am_atow_light", "am_atow_heavy", "am_atow_ap"}}}
...
function SWEP:IndividualThink()
	...
	self.BackupSights = {["doi_atow_zf41"] = {[1] = Vector(-2.3259, -2, 1.08), [2] = Vector(0.9476, 0.0439, 0)}}
	else
	self.BackupSights = {["doi_atow_zf41"] = {[1] = Vector(-2.3262, -2, 1.1502), [2] = Vector(0.2202, 0.0439, 0)}}
	end
