...
if CLIENT then
	...
	SWEP.ZF41Pos = Vector(-2.3575, -3.5, 0.32)
	...
	["doi_atow_zf41"] = {model = "models/khrcw2/doipack/attachments/zf4scope.mdl", pos = Vector(-0.04, -4.2041, 5.525), angle = Angle(0, -90, 0), size = Vector(1.075, 1.075, 1.075), bone = "STG44"},
...
[4] = {header = "Optic", offset = {800, -275}, atts = {"doi_atow_zf41"}},
["+reload"] = {header = "Ammo", offset = {-50, 200}, atts = {"am_atow_light", "am_atow_heavy", "am_atow_ap"}}}
