...
if CLIENT then
	...
	SWEP.ZF41Pos = Vector(-2.6412, -2.5, -0.2323)
	SWEP.ZF41Ang = Vector(0, 0.0186, 0)
	...
	SWEP.BackupSights = {["doi_atow_zf41"] = {[1] = Vector(-2.5062, -2, 0.5482), [2] = Vector(0.2105, 0.0425, 0)},
	...
	["doi_atow_zf41"] = {model = "models/khrcw2/doipack/attachments/zf4scope.mdl", pos = Vector(.2, 0.1041, 3.1), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), bone = "Weapon"},
...
[4] = {header = "Optic", offset = {450, -450}, atts = {"md_ins2kobra","md_ins2eotech552","md_ins2aimpoint","doi_atow_zf41","md_ins2aimpoint2x","md_ins2elcan","md_ins2po424p","md_ins2wsacog"}},
[1] = {header = "Muzzle", offset = {-500, -350}, atts = {"doi_atow_unisuppressor"}},
[3] = {header = "Fire Control", offset = {50, -300}, atts = {"doi_atow_burstconv"}},
["+reload"] = {header = "Ammo", offset = {150, 250}, atts = {"am_atow_light", "am_atow_heavy"}}}
else
SWEP.Attachments = {[2] = {header = "Accessory", offset = {-350, 160}, atts = {"doi_atow_sling"}},
[4] = {header = "Finish", offset = {700, -400}, atts = {"doi_atow_normandycamo"}},
[5] = {header = "Optic", offset = {900, -50}, atts = {"doi_atow_zf41"}},
