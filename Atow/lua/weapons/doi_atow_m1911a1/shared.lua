...
if CLIENT then
	...
	SWEP.Shell = "khr9x19"
	SWEP.ShellScale = .695
	SWEP.ShellDelay = .0325
	SWEP.ShellOffsetMul = 1
	SWEP.ShellPosOffset = {x = .25, y = -2.35, z = 2.9}

	SWEP.IronsightPos = Vector(-1.845, -3, 0.47)
...
["+reload"] = {header = "Ammo", offset = {-350, 100}, atts = {"am_atow_light", "am_atow_heavy", "am_atow_riot"}}}
