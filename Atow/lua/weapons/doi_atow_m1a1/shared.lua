...
["+reload"] = {header = "Ammo", offset = {450, 250}, atts = {"am_atow_light", "am_atow_heavy"}}}
else
...
["+reload"] = {header = "Ammo", offset = {-435, 100}, atts = {"am_atow_light", "am_atow_heavy"}}}
end
