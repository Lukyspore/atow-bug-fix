...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-1.9003, -2, 0.4979)
	...
	SWEP.LuaVMRecoilAxisMod = {vert = 1, hor = .1, roll = 1.5, forward = .4, pitch = .3}
...
["+reload"] = {header = "Ammo", offset = {350, -150}, atts = {"am_atow_light", "am_atow_heavy", "am_atow_riot"}}}
