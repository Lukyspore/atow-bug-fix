...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.12, -2, 0.7924)
	SWEP.IronsightAng = Vector(-0.0121, 0.065, 0)
	
	SWEP.AltIronPos = Vector(-2.1241, -2, 0.615)
...
["+reload"] = {header = "Ammo", offset = {-600, 100}, atts = {"am_atow_light", "am_atow_heavy"}}}
